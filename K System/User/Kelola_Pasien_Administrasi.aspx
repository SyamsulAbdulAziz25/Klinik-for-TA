<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kelola_Pasien_Administrasi.aspx.cs" Inherits="K_System.User.Kelola_Pasien_Administrasi" %>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <form id="Dokter" runat="server">
                    <asp:Button ID="btn_add_pasien" runat="server" CssClass="btn bg-green waves-effect btn-lg" Text="Add Patient" OnClick="btn_add_pasienClick" />
                    <br />
                    <br />
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GridView1" CssClass="gvv table table-bordered table-hover" role="grid" aria-describedby="example2_info" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="kode_pasien" HeaderText="Kode Pasien " />
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <asp:TextBox ID="Tanggal_Lahir" CssClass="form-control" runat="server" TextMode="date" placeholder="Tangal Lahir" required="Required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <asp:Label ID="Label_nomor" runat="server" Text="Nomor Telephon"></asp:Label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <asp:TextBox ID="Nomor_telephon" CssClass="form-control" runat="server" TextMode="Number" placeholder="Nomor Telephon" required="Required"></asp:TextBox>
                                                    </div>
                                                </div>

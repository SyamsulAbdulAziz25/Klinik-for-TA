<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Data_Pembayaran.aspx.cs" Inherits="K_System.User.Data_Pembayaran" %>
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <!-- #END# Browser Usage -->
                <form id="pembayaran" runat="server">
                    <asp:Button ID="btn_add_Pembayaran" runat="server" CssClass="btn bg-green waves-effect btn-lg" Text="Add Pembayaran" OnClick="btn_add_PembayaranClick" />
                    <br />
                    <br />
                        <asp:MultiView ID="MultiView2" runat="server">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="GridView1" CssClass="gvv table table-bordered table-hover" role="grid" aria-describedby="example2_info" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="tarif_dokter" HeaderText="Tarif Dokter" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="obat" HeaderText="Obat" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="tindakan" HeaderText="Tindakan" />
                                                                <asp:BoundField DataField="harga" HeaderText="Harga" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="total" HeaderText="Total" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="bayaran" HeaderText="Pembayaran" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="kembalian" HeaderText="Kembalian" DataFormatString="{0:0,000.00}" />
                                                                <asp:BoundField DataField="metode" HeaderText="Metode Pembayaran" />

                                                                <asp:TemplateField HeaderText="AKSI">
                                                                    <ItemTemplate>
                                                                        <%--                                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%#Eval("kode_pembayaran").ToString() %>' CommandName="Update"><i class="material-icons">create</i></asp:LinkButton>
                                                        <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%#Eval("kode_pembayaran").ToString() %>' CommandName="Delete" OnClientClick="c_val()"><i class="material-icons">delete</i></asp:LinkButton>--%>
                                                                        <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%#Eval("kode_pembayaran").ToString() %>' CommandName="Print"><i class="material-icons">print</i></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <asp:Label ID="Label_K_Pembayaran" runat="server" Text="Kode Pembayaran"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="tx_kode_pembayaran" CssClass="form-control" runat="server" placeholder="Kode Pembayaran" required="Required" Enabled="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <asp:Label ID="Label_K_Kunjungan" runat="server" Text="Kode Kunjungan"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="tx_kode_kunjungan" CssClass="form-control" runat="server" placeholder="Kode Kunjungan" required="Required"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <asp:Label ID="Label_waktu" runat="server" Text="Waktu Pembayaran"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="Tx_Waktu" CssClass="form-control" Style="width: 30%" runat="server" type="date" required="Required"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_klinikConnectionString %>" SelectCommand="SELECT [kode_dokter], [tarif] FROM [tb_dokter]"></asp:SqlDataSource>
                                                    <asp:Label ID="Label_tarif_dr" runat="server" Text="Tarif Dokter"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:DropDownList ID="Dr_tarif" runat="server" Height="30px" Style="width: 30%" DataSourceID="SqlDataSource1" DataTextField="tarif" DataValueField="tarif">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <asp:Label ID="Label_Obat" runat="server" Text="Biaya Obat"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="tx_Obat" CssClass="form-control" runat="server" placeholder="Biaya Obat" required="Required"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="Tx_Tindakan" CssClass="form-control" runat="server" placeholder="Tindakan" required="Required"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <asp:Label ID="Label_Biaya_Tindakan" runat="server" Text="Biaya Tindakan"></asp:Label>
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <asp:TextBox ID="Tx_Biaya_Tindakan" CssClass="form-control" runat="server" placeholder="Biaya Tindakan" required="Required"></asp:TextBox>
                                                        </div>
                                                    </div>


                                                    <asp:Button ID="SAVE" runat="server" CssClass="mt-1 btn btn-success btn-actions-pane-left" Text="SAVE" OnClick="Submit_Click" data-toggle="modal" data-target="#defaultModal" Width="101px" />
                                                    &nbsp;&nbsp;
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="defaultModalLabel">Input Pembayaran</h4>
                                        </div>
                                        <div style="text-align: center; font-size: 18px">
                                            Rp.
                                        <asp:Label ID="Label_Tampil_Total_form_input" runat="server" Text="-"></asp:Label>
                                        </div>
                                        <div class="modal-body">
                                            <asp:Label ID="label_alert" runat="server" Style="text-align: center;" Text=""></asp:Label><br />
                                            <asp:Label ID="Label_Jenis_Pembayaran" runat="server" Text="Jenis Pembayaran"></asp:Label>

                                            <br />
                                            <asp:DropDownList ID="Dr_metode" runat="server">
                                                <asp:ListItem Text="--PIlih Metode Penbayaran--" Value="-1" />
                                                <asp:ListItem Text="Umum" Value="Umum" />
                                                <asp:ListItem Text="BPJS" Value="BPJS" />

                                            </asp:DropDownList>
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <asp:TextBox ID="tx_input_pembayaran" CssClass="form-control" runat="server" placeholder="Input Pembayaran" required="Required" type="number" disabled="disabled"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <asp:Button ID="btn_input_pembayaran" CssClass="mt-1 btn btn-success btn-actions-pane-left" runat="server" Text="SAVE" OnClick="btn_input_pembayaran_Click" />
                                            &nbsp;&nbsp;
                               <asp:Button ID="Button2" runat="server" CssClass="mt-1 btn btn-warning btn-actions-pane-right" Text="CANCLE" formnovalidate="false" OnClick="Cancle_Click" />
                            ...
                            <asp:View ID="View3" runat="server">
                                <div id="div_nota" style="width: 438px; height: 581px; top: 0px; left: 0px;" class="card">
                                    <div class="body">
                                        <div class="table-responsive">
                                            <table style="width: 400px">
                                                ...
                                                <tr>
                                                    <th colspan="2" class="auto-style3">
                                                        <img src="../BS/images/icon_klinik.jpg" width="60" height="40" />
                                                        KLINIK As-Syifa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:Label ID="Label_tampil_waktu" runat="server" Text="-"></asp:Label>
                                                        <br />
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Jl.Cicangkanggirang
                                                ...
                                                <tr>
                                                    <td class="auto-style3">Kode Pembayaran
                                                    </td>
                                                    <td>: 
                                    <asp:Label ID="label_nota_kode_pembayaran" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style3">Nama Pasien
                                                    </td>
                                                    <td>: 
                                    <asp:Label ID="label_nota_nama_pasien" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style3">Poli
                                                    </td>
                                                    <td>: 
                                    <asp:Label ID="label_nota_poli" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style3">Nama Dokter
                                                    </td>
                                                    <td>: 
                                    <asp:Label ID="label_nota_nama_dokter" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style3">Kode Kunjungan
                                                    </td>
                                                    <td>: 
                                    <asp:Label ID="label_nota_kode_kunjungan" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                                ...
                                                <tr style="text-align: center; border-color: black; font: bold">
                                                    <td>Jenis Transaksi
                                                    </td>
                                                    <td>Biaya
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>: Rp. 
                                    <asp:Label ID="label_nota_biaya_pemeriksaan" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Obat
                                                    ...
                                                    <td>: Rp. 
                                    <asp:Label ID="label_nota_harga_obat" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Tindakan Tambahan
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="label_nota_nama_tindakan" Text="-" runat="server"></asp:Label>
                                                    </td>
                                                    <td>: Rp. 
                                            <asp:Label ID="label_nota_biaya_tindakan" Text="-" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>: Rp. 
                                            <asp:Label ID="label_nota_total" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Pembayaran
                                                    ...
                                                    <td>: Rp. 
                                            <asp:Label ID="Label_nota_pembayaran" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Kembalian
                                                    ...
                                                    <td>: Rp. 
                                            <asp:Label ID="Label_Kembalian" runat="server" Text="-"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="text-align: center; font-style: italic" colspan="2">
                                                        <asp:Label ID="Label_print" Text="---- Nota Asli ----" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <div id="editor" style="margin-bottom: 10px">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="SAVE0" runat="server" CssClass="mt-1 btn btn-success btn-actions-pane-left" Height="34px" Text="Print" Width="101px" OnClick="SAVE0_Click1" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="CANCLE0" runat="server" CssClass="mt-1 btn btn-warning btn-actions-pane-right" formnovalidate="false" Height="34px" OnClick="CANCLE0_Click" Text="Close" Width="97px" />
                                </div>
                            </asp:View>
                ...
                <script>
                    $("#SAVE0").click(function () {
                        var nota_print = document.getElementById("div_nota").innerHTML;
                        var backup = document.body.innerHTML;
                        document.body.innerHTML = nota_print;
                        window.print();
